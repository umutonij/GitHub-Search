...
export class ProfileService {
  ...
  const promise = new Promise((resolve, reject) => {
    this.http.get<ApiResponse>( 'https://api.github.com/users/'+ username + "?access_token=de0a71619d2e657c3e1e6d2761bb1f1de1a92dc0 ").toPromise().then(profile => {
...
this.http.get<ApiResponse>('https://api.github.com/users/' + username + "/repos?access_token=de0a71619d2e657c3e1e6d2761bb1f1de1a92dc0 ").subscribe(response => {
